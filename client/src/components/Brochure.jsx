  ...
  const handleDownload = (type = 'png') => {
    ...
    try {
      ...
      if (type === 'pdf') {
        ...
        link.href = '/CSE Symposium OG Final Final.png';
    ...
    <section id="brochure" className="py-20 px-4">
      ...
      <div className="text-center mb-12">
        ...
        <p className="max-w-2xl mx-auto text-gray-400">
          View or download the official RYVONEXA '26 brochure poster for complete event details and guidelines.
        </p>
      </div>
      ...
      <div className="max-w-5xl mx-auto glass-card p-6 md:p-10 border-cyan-500/30 relative overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          {/* Brochure Image Card Preview (Column 5) */}
          <div className="lg:col-span-5 flex justify-center">
            <div
              onClick={() => setIsModalOpen(true)}
              className="relative group cursor-pointer w-full max-w-sm rounded-2xl overflow-hidden border border-cyan-500/40 bg-[#0a0d24] shadow-[0_0_35px_rgba(0,240,255,0.2)] hover:shadow-[0_0_45px_rgba(0,240,255,0.4)] transition-all duration-300 transform group-hover:scale-[1.02]"
            >
              {/* Poster Image */}
              <div className="relative aspect-[4/3] sm:aspect-[1.41] overflow-hidden bg-black/60">
                <img
                  src="/CSE Symposium OG Final Final.png"
                  alt="RYVONEXA '26 Brochure Poster"
          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            ...
            <p className="text-gray-300 text-sm mb-6 leading-relaxed font-light">
              Get all information regarding Technical & Non-Technical events, cash prizes, schedule, staff and student coordinators in one official poster layout.
            </p>

            <ul className="space-y-3 mb-8 text-sm text-gray-300 font-light">
              <li className="flex items-center gap-2.5">
                <CheckCircle className="w-4 h-4 text-cyan-400 shrink-0" />
                <span>Includes TechTalk Arena, Code Relay, Prompt Cipher & Frontend Fix-It</span>
              </li>
              <li className="flex items-center gap-2.5">
                <CheckCircle className="w-4 h-4 text-purple-400 shrink-0" />
                <span>Non-Technical events: Tech Gamble, Crack The Vault, Memory Wall & Aura Unlocked</span>
              </li>
              <li className="flex items-center gap-2.5">
                <CheckCircle className="w-4 h-4 text-amber-400 shrink-0" />
                <span>Registration details, helpline numbers & coordinator contacts</span>
              </li>
            </ul>
